...
def draw_box(box: Box ):
    ...
    for i in range(3):
        draw_line_ex(Vector2(vertices[0,i], vertices[1,i]), Vector2(vertices[0, i+1], vertices[1, i+1]), 5, BLUE)
        pass
    draw_line_ex(Vector2(vertices[0,3], vertices[1,3]), Vector2(vertices[0, 0], vertices[1, 0]), 5, BLUE)
    pass
